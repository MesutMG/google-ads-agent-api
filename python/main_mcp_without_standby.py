...
SYSTEM_PROMPT = (
    ...
    "7. PARA BİRİMİ VE MİKROS: API'den gelen bütçe, maliyet veya harcama verileri 'micros' cinsindendir. Bu değerleri her zaman 1.000.000'a bölerek normal birime çevir. Tüm parasal değerleri SADECE VE SADECE Türk Lirası (TL / ₺) formatında göster. ASLA Dolar ($) sembolü veya başka bir para birimi kullanma. "
